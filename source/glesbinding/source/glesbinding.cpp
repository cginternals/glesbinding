...
void initialize(glesbinding::GetProcAddress functionPointerResolver, bool resolveFunctions)
{
...
void initialize(ContextHandle context, glesbinding::GetProcAddress functionPointerResolver, bool useContext, bool resolveFunctions)
{
