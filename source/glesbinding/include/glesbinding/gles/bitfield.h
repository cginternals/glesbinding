...
GLESBINDING_CONSTEXPR static const glesbinding::SharedBitfield<AttribMask, BufferAccessMask, BufferBitQCOM, BufferStorageMask, ClearBufferMask, ContextFlagMask, FoveationConfigBitQCOM, MapBufferAccessMask, MemoryBarrierMask, PathFontStyle, PathMetricMask, PathRenderingMaskNV, PerformanceQueryCapsMaskINTEL, SyncObjectMask, UnusedMask, UseProgramStageMask> GL_NONE_BIT = AttribMask::GL_NONE_BIT;
...
GLESBINDING_CONSTEXPR static const FoveationConfigBitQCOM GL_FOVEATION_SUBSAMPLED_LAYOUT_METHOD_BIT_QCOM = FoveationConfigBitQCOM::GL_FOVEATION_SUBSAMPLED_LAYOUT_METHOD_BIT_QCOM;
...
GLESBINDING_CONSTEXPR static const glesbinding::SharedBitfield<BufferAccessMask, BufferStorageMask, MapBufferAccessMask> GL_MAP_READ_BIT = BufferAccessMask::GL_MAP_READ_BIT;
...
GLESBINDING_CONSTEXPR static const glesbinding::SharedBitfield<BufferAccessMask, BufferStorageMask, MapBufferAccessMask> GL_MAP_WRITE_BIT = BufferAccessMask::GL_MAP_WRITE_BIT;
...
GLESBINDING_CONSTEXPR static const glesbinding::SharedBitfield<BufferAccessMask, MapBufferAccessMask> GL_MAP_INVALIDATE_RANGE_BIT = BufferAccessMask::GL_MAP_INVALIDATE_RANGE_BIT;
...
GLESBINDING_CONSTEXPR static const glesbinding::SharedBitfield<BufferAccessMask, MapBufferAccessMask> GL_MAP_INVALIDATE_BUFFER_BIT = BufferAccessMask::GL_MAP_INVALIDATE_BUFFER_BIT;
...
GLESBINDING_CONSTEXPR static const glesbinding::SharedBitfield<BufferAccessMask, MapBufferAccessMask> GL_MAP_FLUSH_EXPLICIT_BIT = BufferAccessMask::GL_MAP_FLUSH_EXPLICIT_BIT;
...
GLESBINDING_CONSTEXPR static const glesbinding::SharedBitfield<BufferAccessMask, MapBufferAccessMask> GL_MAP_UNSYNCHRONIZED_BIT = BufferAccessMask::GL_MAP_UNSYNCHRONIZED_BIT;
...
GLESBINDING_CONSTEXPR static const glesbinding::SharedBitfield<BufferAccessMask, BufferStorageMask, MapBufferAccessMask> GL_MAP_PERSISTENT_BIT = BufferAccessMask::GL_MAP_PERSISTENT_BIT;
...
GLESBINDING_CONSTEXPR static const glesbinding::SharedBitfield<BufferAccessMask, BufferStorageMask, MapBufferAccessMask> GL_MAP_COHERENT_BIT = BufferAccessMask::GL_MAP_COHERENT_BIT;
...
GLESBINDING_CONSTEXPR static const BufferStorageMask GL_DYNAMIC_STORAGE_BIT = BufferStorageMask::GL_DYNAMIC_STORAGE_BIT;
...
GLESBINDING_CONSTEXPR static const BufferStorageMask GL_CLIENT_STORAGE_BIT = BufferStorageMask::GL_CLIENT_STORAGE_BIT;
...
GLESBINDING_CONSTEXPR static const BufferStorageMask GL_SPARSE_STORAGE_BIT_ARB = BufferStorageMask::GL_SPARSE_STORAGE_BIT_ARB;
...
GLESBINDING_CONSTEXPR static const BufferStorageMask GL_LGPU_SEPARATE_STORAGE_BIT_NVX = BufferStorageMask::GL_LGPU_SEPARATE_STORAGE_BIT_NVX;
GLESBINDING_CONSTEXPR static const BufferStorageMask GL_PER_GPU_STORAGE_BIT_NV = BufferStorageMask::GL_PER_GPU_STORAGE_BIT_NV;
...
GLESBINDING_CONSTEXPR static const BufferStorageMask GL_EXTERNAL_STORAGE_BIT_NVX = BufferStorageMask::GL_EXTERNAL_STORAGE_BIT_NVX;
