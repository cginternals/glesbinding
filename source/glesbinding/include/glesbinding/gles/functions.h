...
GLESBINDING_API void glActiveProgramEXT(GLuint program);
...
GLESBINDING_API void glBlendEquationEXT(GLenum mode);
...
GLESBINDING_API void glBlitFramebufferLayerEXT(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint srcLayer, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLint dstLayer, ClearBufferMask mask, GLenum filter);
GLESBINDING_API void glBlitFramebufferLayersEXT(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, ClearBufferMask mask, GLenum filter);
...
GLESBINDING_API void glBufferPageCommitmentMemNV(GLenum target, GLintptr offset, GLsizeiptr size, GLuint memory, GLuint64 memOffset, GLboolean commit);
...
GLESBINDING_API void glCreateSemaphoresNV(GLsizei n, GLuint * semaphores);
GLESBINDING_API GLuint glCreateShader(GLenum type);
GLESBINDING_API GLuint glCreateShaderProgramEXT(GLenum type, const GLchar * string);
GLESBINDING_API GLuint glCreateShaderProgramv(GLenum type, GLsizei count, const GLchar *const* strings);
GLESBINDING_API GLuint glCreateShaderProgramvEXT(GLenum type, GLsizei count, const GLchar *const* strings);
...
GLESBINDING_API void glExtrapolateTex2DQCOM(GLuint src1, GLuint src2, GLuint output, GLfloat scaleFactor);
GLESBINDING_API void glExtTexObjectStateOverrideiQCOM(GLenum target, GLenum pname, GLint param);
GLESBINDING_API GLsync glFenceSync(GLenum condition, GLbitfield flags);
...
GLESBINDING_API void glFramebufferParameteriMESA(GLenum target, GLenum pname, GLint param);
...
GLESBINDING_API void glFramebufferShadingRateEXT(GLenum target, GLenum attachment, GLuint texture, GLint baseLayer, GLsizei numLayers, GLsizei texelWidth, GLsizei texelHeight);
...
GLESBINDING_API void glGetFragmentShadingRatesEXT(GLsizei samples, GLsizei maxCount, GLsizei * count, GLenum * shadingRates);
...
GLESBINDING_API void glGetFramebufferParameterivMESA(GLenum target, GLenum pname, GLint * params);
...
GLESBINDING_API void glGetInteger64vEXT(GLenum pname, GLint64 * data);
...
GLESBINDING_API void glGetInternalformativ(GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint * params);
GLESBINDING_API void glGetInternalformatSampleivNV(GLenum target, GLenum internalformat, GLsizei samples, GLenum pname, GLsizei count, GLint * params);
...
GLESBINDING_API void glGetPathColorGenfvNV(GLenum color, GLenum pname, GLfloat * value);
GLESBINDING_API void glGetPathColorGenivNV(GLenum color, GLenum pname, GLint * value);
...
GLESBINDING_API void glGetPathMetricRangeNV(PathMetricMask metricQueryMask, GLuint firstPathName, GLsizei numPaths, GLsizei stride, GLfloat * metrics);
GLESBINDING_API void glGetPathMetricsNV(PathMetricMask metricQueryMask, GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLsizei stride, GLfloat * metrics);
...
GLESBINDING_API void glGetPathTexGenfvNV(GLenum texCoordSet, GLenum pname, GLfloat * value);
GLESBINDING_API void glGetPathTexGenivNV(GLenum texCoordSet, GLenum pname, GLint * value);
...
GLESBINDING_API void glGetPerfQueryInfoINTEL(GLuint queryId, GLuint queryNameLength, GLchar * queryName, GLuint * dataSize, GLuint * noCounters, GLuint * noInstances, PerformanceQueryCapsMaskINTEL capsMask);
...
GLESBINDING_API void glGetProgramResourcefvNV(GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum * props, GLsizei count, GLsizei * length, GLfloat * params);
GLESBINDING_API GLuint glGetProgramResourceIndex(GLuint program, GLenum programInterface, const GLchar * name);
GLESBINDING_API void glGetProgramResourceiv(GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum * props, GLsizei count, GLsizei * length, GLint * params);
...
GLESBINDING_API void glGetSemaphoreParameterivNV(GLuint semaphore, GLenum pname, GLint * params);
...
GLESBINDING_API void glGetSynciv(GLsync sync, GLenum pname, GLsizei count, GLsizei * length, GLint * values);
GLESBINDING_API void glGetSyncivAPPLE(GLsync sync, GLenum pname, GLsizei count, GLsizei * length, GLint * values);
...
GLESBINDING_API void glMultiDrawElementsBaseVertexEXT(GLenum mode, const GLsizei * count, GLenum type, const void *const* indices, GLsizei drawcount, const GLint * basevertex);
...
GLESBINDING_API void glNamedBufferPageCommitmentMemNV(GLuint buffer, GLintptr offset, GLsizeiptr size, GLuint memory, GLuint64 memOffset, GLboolean commit);
...
GLESBINDING_API void glPathColorGenNV(GLenum color, GLenum genMode, GLenum colorFormat, const GLfloat * coeffs);
...
GLESBINDING_API void glPathFogGenNV(GLenum genMode);
...
GLESBINDING_API GLenum glPathGlyphIndexRangeNV(GLenum fontTarget, const void * fontName, PathFontStyle fontStyle, GLuint pathParameterTemplate, GLfloat emScale, GLuint * baseAndCount);
...
GLESBINDING_API void glPathTexGenNV(GLenum texCoordSet, GLenum genMode, GLint components, const GLfloat * coeffs);
...
GLESBINDING_API void glSemaphoreParameterivNV(GLuint semaphore, GLenum pname, const GLint * params);
...
GLESBINDING_API void glShadingRateCombinerOpsEXT(GLenum combinerOp0, GLenum combinerOp1);
GLESBINDING_API void glShadingRateEXT(GLenum rate);
...
GLESBINDING_API void glShadingRateQCOM(GLenum rate);
...
GLESBINDING_API void glTexEstimateMotionQCOM(GLuint ref, GLuint target, GLuint output);
GLESBINDING_API void glTexEstimateMotionRegionsQCOM(GLuint ref, GLuint target, GLuint output, GLuint mask);
...
GLESBINDING_API void glTexPageCommitmentMemNV(GLenum target, GLint layer, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLuint memory, GLuint64 offset, GLboolean commit);
...
GLESBINDING_API void glTexStorageAttribs2DEXT(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, const GLint* attrib_list);
GLESBINDING_API void glTexStorageAttribs3DEXT(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, const GLint* attrib_list);
GLESBINDING_API void glTexStorageMem1DEXT(GLenum target, GLsizei levels, GLenum internalFormat, GLsizei width, GLuint memory, GLuint64 offset);
...
GLESBINDING_API void glTextureStorageMem1DEXT(GLuint texture, GLsizei levels, GLenum internalFormat, GLsizei width, GLuint memory, GLuint64 offset);
...
GLESBINDING_API void glUseProgramStagesEXT(GLuint pipeline, UseProgramStageMask stages, GLuint program);
GLESBINDING_API void glUseShaderProgramEXT(GLenum type, GLuint program);
...
GLESBINDING_API void glWaitSync(GLsync sync, GLbitfield flags, GLuint64 timeout);
