...
const std::unordered_map<GLextension, std::set<std::string>> Meta_FunctionStringsByExtension =
{
    ...
    { GLextension::GL_ARM_shader_core_properties, { "glMaxActiveShaderCoresARM" } },
    ...
    { GLextension::GL_EXT_disjoint_timer_query, { "glBeginQueryEXT", "glDeleteQueriesEXT", "glEndQueryEXT", "glGenQueriesEXT", "glGetInteger64vEXT", "glGetQueryivEXT", "glGetQueryObjecti64vEXT", "glGetQueryObjectivEXT", "glGetQueryObjectui64vEXT", "glGetQueryObjectuivEXT", "glIsQueryEXT", "glQueryCounterEXT" } },
    ...
    { GLextension::GL_EXT_fragment_shading_rate, { "glFramebufferShadingRateEXT", "glGetFragmentShadingRatesEXT", "glShadingRateCombinerOpsEXT", "glShadingRateEXT" } },
    ...
    { GLextension::GL_EXT_texture_storage_compression, { "glTexStorageAttribs2DEXT", "glTexStorageAttribs3DEXT" } },
    ...
    { GLextension::GL_MESA_sampler_objects, { "glBindSampler", "glDeleteSamplers", "glGenSamplers", "glGetSamplerParameterfv", "glGetSamplerParameteriv", "glIsSampler", "glSamplerParameterf", "glSamplerParameterfv", "glSamplerParameteri", "glSamplerParameteriv" } },
    ...
    { GLextension::GL_QCOM_frame_extrapolation, { "glExtrapolateTex2DQCOM" } },
    { GLextension::GL_QCOM_framebuffer_foveated, { "glFramebufferFoveationConfigQCOM", "glFramebufferFoveationParametersQCOM" } },
    { GLextension::GL_QCOM_motion_estimation, { "glTexEstimateMotionQCOM", "glTexEstimateMotionRegionsQCOM" } },
    { GLextension::GL_QCOM_shader_framebuffer_fetch_noncoherent, { "glFramebufferFetchBarrierQCOM" } },
    { GLextension::GL_QCOM_shading_rate, { "glShadingRateQCOM" } },
