...
const std::unordered_map<GLextension, std::set<std::string>> Meta_FunctionStringsByExtension =
{
    ...
    { GLextension::GL_EXT_disjoint_timer_query, { "glBeginQueryEXT", "glDeleteQueriesEXT", "glEndQueryEXT", "glGenQueriesEXT", "glGetQueryivEXT", "glGetQueryObjecti64vEXT", "glGetQueryObjectivEXT", "glGetQueryObjectui64vEXT", "glGetQueryObjectuivEXT", "glIsQueryEXT", "glQueryCounterEXT" } },
    { GLextension::GL_EXT_draw_buffers, { "glDrawBuffersEXT" } },
    { GLextension::GL_EXT_draw_buffers_indexed, { "glBlendEquationiEXT", "glBlendEquationSeparateiEXT", "glBlendFunciEXT", "glBlendFuncSeparateiEXT", "glColorMaskiEXT", "glDisableiEXT", "glEnableiEXT", "glIsEnablediEXT" } },
    ...
    { GLextension::GL_EXT_occlusion_query_boolean, { "glBeginQueryEXT", "glDeleteQueriesEXT", "glEndQueryEXT", "glGenQueriesEXT", "glGetQueryivEXT", "glGetQueryObjectuivEXT", "glIsQueryEXT" } },
    ...
    { GLextension::GL_EXT_separate_shader_objects, { "glActiveProgramEXT", "glActiveShaderProgramEXT", "glBindProgramPipelineEXT", "glCreateShaderProgramEXT", "glCreateShaderProgramvEXT", "glDeleteProgramPipelinesEXT", "glGenProgramPipelinesEXT", "glGetProgramPipelineInfoLogEXT", "glGetProgramPipelineivEXT", "glIsProgramPipelineEXT", "glProgramParameteriEXT", "glProgramUniform1fEXT", "glProgramUniform1fvEXT", "glProgramUniform1iEXT", "glProgramUniform1ivEXT", "glProgramUniform1uiEXT", "glProgramUniform1uivEXT", "glProgramUniform2fEXT", "glProgramUniform2fvEXT", "glProgramUniform2iEXT", "glProgramUniform2ivEXT", "glProgramUniform2uiEXT", "glProgramUniform2uivEXT", "glProgramUniform3fEXT", "glProgramUniform3fvEXT", "glProgramUniform3iEXT", "glProgramUniform3ivEXT", "glProgramUniform3uiEXT", "glProgramUniform3uivEXT", "glProgramUniform4fEXT", "glProgramUniform4fvEXT", "glProgramUniform4iEXT", "glProgramUniform4ivEXT", "glProgramUniform4uiEXT", "glProgramUniform4uivEXT", "glProgramUniformMatrix2fvEXT", "glProgramUniformMatrix2x3fvEXT", "glProgramUniformMatrix2x4fvEXT", "glProgramUniformMatrix3fvEXT", "glProgramUniformMatrix3x2fvEXT", "glProgramUniformMatrix3x4fvEXT", "glProgramUniformMatrix4fvEXT", "glProgramUniformMatrix4fvEXT", "glProgramUniformMatrix4x2fvEXT", "glProgramUniformMatrix4x3fvEXT", "glUseProgramStagesEXT", "glUseShaderProgramEXT", "glValidateProgramPipelineEXT" } },
    ...
    { GLextension::GL_NV_shading_rate_image, { "glBindShadingRateImageNV", "glGetShadingRateImagePaletteNV", "glGetShadingRateSampleLocationivNV", "glShadingRateImageBarrierNV", "glShadingRateImageBarrierNV", "glShadingRateImagePaletteNV", "glShadingRateSampleOrderCustomNV", "glShadingRateSampleOrderNV" } },
    ...
    { GLextension::GL_OES_draw_buffers_indexed, { "glBlendEquationiOES", "glBlendEquationSeparateiOES", "glBlendFunciOES", "glBlendFuncSeparateiOES", "glColorMaskiOES", "glDisableiOES", "glEnableiOES", "glIsEnablediOES" } },
    ...
    { GLextension::GL_QCOM_driver_control, { "glDisableDriverControlQCOM", "glEnableDriverControlQCOM", "glGetDriverControlsQCOM", "glGetDriverControlStringQCOM" } },
